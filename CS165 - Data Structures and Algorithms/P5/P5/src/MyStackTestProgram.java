...
public class MyStackTestProgram {
    ...
    public static void testSearch(Stack<String> javaStack, MyStack<String> myStack){
        System.err.println("Testing Search: ");
        pushRandom(javaStack, 1234);
        pushRandom(myStack, 1234);
        ...
        System.err.println("javaStack.search(\"1202\"): " + javaStack.search("1202"));
        System.err.println("coolStack.search(\"1202\"): " + myStack.search("1202"));
