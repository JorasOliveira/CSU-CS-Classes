...
public class Recursion {
    ...
    public static String dedupeChars(String word){
        ...
        else if(word.toLowerCase().charAt(0) == word.toLowerCase().charAt(1)){
            return dedupeChars(word.substring(1, word.length()));
        }
        else{
            return word.charAt(0) + dedupeChars(word.substring(1, word.length()));
        }
