...
public class Project {
    ...
    public void completeProject(){
        ...
        while (linesOfCode > linesWriten + linesTested){
            daysWorkedSoFar++;

            for (int i = 0; i < employeesOnProject.size(); i++) {
                if (employeesOnProject.get(i) instanceof Programmer) {
                    linesWriten += employeesOnProject.get(i).work();
                }

                if (employeesOnProject.get(i) instanceof Tester) {
                    linesTested += employeesOnProject.get(i).work();
                }
            }
        }
    }
    ...
    public String toString(){
        ...
        for (int i = 0; i < employeesOnProject.size(); i ++){
            ...
            toString += employeesOnProject.get(i).toString() + "\n";
        }
